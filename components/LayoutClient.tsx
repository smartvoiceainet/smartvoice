...
import { VoiceAIAccessProvider } from "@/contexts/VoiceAIAccessContext";
...
const ClientLayout = ({ children }: { children: ReactNode }) => {
  return (
    <>
      <SessionProvider>
        {/* Wrap everything with VoiceAIAccessProvider to make voice AI access controls available throughout the app */}
        <VoiceAIAccessProvider>
