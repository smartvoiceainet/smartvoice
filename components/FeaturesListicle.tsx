      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-base-100 max-md:px-8 max-w-3xl">
          ...
          <div className="text-base-content/80 leading-relaxed mb-8 lg:text-lg">
            ...
            Handle client inquiries, schedule appointments, and qualify potential cases automatically. Spend
            your time working on cases, not answering routine phone calls. Smart Voice AI
            provides you with the intelligent voice assistant your law practice needs.
          </div>
        </div>
      </div>
