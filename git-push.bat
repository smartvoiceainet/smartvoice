@echo off
echo Running Git Push Script for smartvoiceai.net
echo ==========================================

echo Setting remote repository to https://github.com/smartvoiceainet/smartvoice...
git remote remove origin 2>nul
git remote add origin https://github.com/smartvoiceainet/smartvoice.git
...
if /i "%confirm%"=="Y" (
  echo Pushing to GitHub repository: https://github.com/smartvoiceainet/smartvoice
