...
export const categories: categoryType[] = [
  {
    ...
    description:
      "Here are the latest features we've added to Smart Voice AI. We're constantly improving our product to help your law firm communicate more efficiently.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to Smart Voice AI.",
  },
  {
    ...
    description:
      "Learn how to use Smart Voice AI with these step-by-step tutorials. We'll show you how to automate client communication and save time.",
    descriptionShort:
      "Learn how to use Smart Voice AI with these step-by-step tutorials.",
  },
];
...
export const articles: articleType[] = [
  {
    ...
    title: "Introducing Supabase to Smart Voice AI",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a secure backend for your AI voice assistant. It's now integrated with Smart Voice AI!",
    ...
    image: {
      ...
      alt: "Supabase and Smart Voice AI logo combined",
    },
      ...
      <>
        ...
        <section>
          ...
          <p className={styles.p}>
            ...
            tool for building a secure backend for your AI voice assistant. It&apos;s now integrated
            with Smart Voice AI!
          </p>
        </section>
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to Smart Voice AI</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your Smart Voice AI project
