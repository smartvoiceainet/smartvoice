...
import VoiceAssistantDiagnostics from '@/components/Admin/VoiceAssistantDiagnostics';
    ...
    <VoiceAIProtectedFeature>
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold">Voice Assistant Management</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 mb-3">
                Having issues with voice integration? Check our troubleshooting guide for common solutions.
              </p>
              <Link href="/docs/voice-troubleshooting.md" className="text-blue-600 hover:underline">
                View Troubleshooting Guide →
              </Link>
            </div>
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="font-medium text-lg mb-2">Voice API Documentation</h3>
              <p className="text-gray-600 mb-3">
                Learn more about our voice API capabilities and how to configure assistants.
              </p>
              <a 
